...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'SuperGroup has been added by ['..msg.from.id..']!telegram.me'..msg.from.user..':|'
      return reply_msg(msg.id, text, ok_cb, false)
			--send_api_msg(msg,get_receiver_api(msg),text,true,'md',msg.id,us,)
    end
  end
end
...
local function automodadd2(msg)
...
local function lock_group_welcome(msg, data, target)
  ...
  if group_welcome_lock == '✅' then
    return 'Welcome message is already enabled'
  else
    data[tostring(target)]['settings']['welcome'] = '✅'
    save_data(_config.moderation.data, data)
    return 'Welcome message has been enabled'
  end
end
...
local function unlock_group_welcome(msg, data, target)
  ...
  local group_welcome_lock = data[tostring(target)]['settings']['welcome']
  if group_welcome_lock == '❌' then
    return 'Welcome message is already disabled'
  else
    data[tostring(target)]['settings']['welcome'] = '❌'
    save_data(_config.moderation.data, data)
    return 'Welcome message has been disabled'
  end
end
...
if data[tostring(target)]['settings'] then
    ...
    local group_type = "SuperGroup"
    if  data[tostring(msg.to.id)]['group_type'] then
    group_type = data[tostring(msg.to.id)]['group_type']
    end
    local version = "10"
    if redis:get('bot:version2') then
    version = redis:get('bot:version2')
    end
  ...
  local text = "*SuperGroup Settings For :*\n*[ "..msg.to.title.." ]*"
    ...
    {
                {text = 'Lock SuperGroup Links', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_link, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Flood', url = 'Telegram.Me/thisismobin'},
                {text = settings.flood, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Spam', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_spam, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Arabic', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_arabic, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Member', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_member, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup RTL', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_rtl, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Sticker', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_sticker, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup All', url = 'Telegram.Me/thisismobin'},
                {text = settings.mute_all, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Text', url = 'Telegram.Me/thisismobin'},
                {text = settings.mute_text, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Photo', url = 'Telegram.Me/thisismobin'},
                {text = settings.mute_photo, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Video', url = 'Telegram.Me/thisismobin'},
                {text = settings.mute_video, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Audio', url = 'Telegram.Me/thisismobin'},
                {text = settings.mute_audio, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Gifs', url = 'Telegram.Me/thisismobin'},
                {text = settings.mute_gif, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup Contacts', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_contacts, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Lock SuperGroup File', url = 'Telegram.Me/thisismobin'},
                {text = settings.mute_doc, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'SuperGroup Public', url = 'Telegram.Me/thisismobin'},
                {text = settings.public, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'SuperGroup Type', url = 'Telegram.Me/thisismobin'},
                {text = group_type, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Welcome Message', url = 'Telegram.Me/thisismobin'},
                {text = settings.welcome, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Bots Protection', url = 'Telegram.Me/thisismobin'},
                {text = settings.lock_bots, url = 'Telegram.Me/thisismobin'},
      },
    {
                {text = 'Bot Version', url = 'Telegram.Me/thisismobin'},
                {text = version, url = 'Telegram.Me/thisismobin'},
      },
    }
...
function get_message_callback(extra, success, result)
   ...
   local name = string.sub(result.from.first_name, 1, 40)
...
send_api_msg(msg.to.id, get_receiver_api(msg), "*User* _"..name.."_ *Has* _Been_ *Kicked*", true, 'md')
		kick_user(member_id, channel_id)
	elseif get_cmd == 'channel_block' and result.action and result.action.type == 'chat_add_user' then
		local user_id = result.action.user.peer_id
		local channel_id = result.to.peer_id
   local name = string.sub(result.action.user.first_name, 1, 40)
    if member_id == msg.from.id then
      return send_large_msg("channel#id"..channel_id, "Leave using kickme command")
    end
    if is_momod2(member_id, channel_id) and not is_admin2(msg.from.id) then
...
local function callbackres(extra, success, result)
  ...
  elseif get_cmd == "invite" then
	...
	--[[elseif get_cmd == "channel_block" then
		local user_id = result.peer_id
   local name = string.sub(result.first_name, 1, 40)
...
send_api_msg(msg.to.id, get_receiver_api(msg), "*User* _"..user_id.."_ *Has* _Been_ *Kicked*", true, 'md')
      kick_user(user_id, channel_id)
      return
    end
  end
...
local function run(msg, matches)
  ...
  if matches[1]:lower() == 'add' and not matches[2] then
		...
		if matches[1] == "owner" then
 			local group_owner = data[tostring(msg.to.user)]['set_owner']
			if not group_owner then
				return "no owner,ask admins in support groups to set owner for your SuperGroup"
			end
			savelog(msg.to.id, name_log.." ["..msg.from.username.."] used /owner")
				local text = "owner is *\n["..msg.from.username.."]("..group_owner..")"
    ...
    return automodadd2(msg)
		...
		if matches[1]:lower() == 'kick' and is_momod(msg) then
			if type(msg.reply_id) ~= "nil" then
				...
				get_message(msg.reply_id, get_message_callback, cbreply_extra)
			elseif matches[1]:lower() == 'kick' and matches[2] and string.match(matches[2], '^%d+$') then
			...
			elseif matches[1]:lower() == "kick" and matches[2] and not string.match(matches[2], '^%d+$') then
			--[[local cbres_extra = {
					channelid = msg.to.id,
					get_cmd = 'channel_block',
					sender = msg.from.id
		...
		if matches[1]:lower() == 'id' then
			...
			elseif msg.text:match("@[%a%d]") then
				...
				local text = "*"..msg.to.title.."*\n_#Chat ID : "..msg.to.id.."_\n*#Your ID : "..msg.from.id.."*"
send_api_msg(msg,get_receiver_api(msg),text,true,'md',msg.from.firstname)
			end
		end

		if matches[1]:lower() == 'kickme1' then
			if msg.to.type == 'channel' then
		...
		if matches[1]:lower() == 'link' then
			...
			if not group_link then
				return "Set a link using /setlink first!"
			end
...
send_api_msg(msg,get_receiver_api(msg),text,true,'md',msg.to.title,group_link)
		...
		if matches[1]:lower() == 'setflood' then
			...
			if tonumber(matches[2]) < 1 or tonumber(matches[2]) > 1000 then
		...
		if matches[1]:lower() == 'lock' and is_momod(msg) then
			...
			local msg_type = 'Audio'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return msg_type.." is already locked"
				end
			end
			...
			local msg_type = 'All'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return "Lock "..msg_type.." is already enabled"
				end
			end
		end
		if matches[1]:lower() == 'unlock' and is_momod(msg) then
			...
			local msg_type = 'Audio'
				if is_muted(chat_id, msg_type..': yes') then
					...
					return msg_type.." is already unlocked"
				end
			end
			if matches[2] == 'photo' then
			local msg_type = 'Photo'
